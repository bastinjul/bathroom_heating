...
config :home_automation, HomeAutomationWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: HomeAutomationWeb.ErrorView, accepts: ~w(html json), layout: false],
...
config :home_automation, HomeAutomation.Mailer, adapter: Swoosh.Adapters.Local
